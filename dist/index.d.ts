...
export default class LazyPromise<T> {
     ...
     */
    then(onfulfilled: ((value: T) => T | PromiseLike<T>) | null | undefined, onrejected: ((reason: any) => PromiseLike<never>) | null | undefined): Promise<T>;
    /**
     ...
     */
    catch(onrejected: ((reason: any) => PromiseLike<never>) | null | undefined): Promise<T>;
    /**
